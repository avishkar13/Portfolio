            ...
            <div className="skill-container text-white w-[90vw]  mx-auto  my-24 flex flex-col gap-8 bg-red-30 p-1 md:p-2">
                <div className="card w-full md:w-[80%] xl:w-[50%] bg-gray-800 rounded-lg shadow-lg p-6 text-white mx-auto">
                    ...
                    <div className="technology mb-4 flex items-center">
                        <img src="public\images/html.png" alt="HTML" className="w-6 h-6 mr-2 " />
                    ...
                    <div className="technology mb-4 flex  items-center">
                        <img src="public\images/css.png" alt="CSS" className="w-6 h-6 mr-2" />
                        <div className="flex-grow">
                            <div className="flex justify-between items-center">
                    ...
                    <div className="technology mb-4 flex items-center">
                        <img src="public\images/js.png" alt="JavaScript" className="w-6 h-6 mr-2" />
                        <div className="flex-grow">
                    ...
                    <div className="frontend mb-4 flex items-center">
                        <img src="public\images/react.png" alt="React" className="w-6 h-6 mr-2" />
                        <div className="flex-grow">
                            <div className="flex justify-between">
                    ...
                    <div className="technology mb-4 flex items-center">
                        <img src="public\images/next.png" alt="Next.js" className="w-6 h-6 mr-2 bg-white" />
                        <div className="flex-grow">
                            <div className="flex justify-between">
                ...
                <div className="card w-full md:w-[80%] xl:w-[50%] bg-gray-800 rounded-lg shadow-lg p-6 text-white mx-auto">
                    ...
                    <div className="technology mb-4 flex items-center">
                        <img src="public\images/node.png" alt="HTML" className="w-6 h-6 mr-2 bg-white rounded-sm" />
                        <div className="flex-grow">
                            <div className="flex justify-between">
                    ...
                    <div className="technology mb-4 flex items-center">
                        <img src="public\images/express.png" alt="CSS" className="w-6 h-6 mr-2 bg-white rounded-sm" />
                        <div className="flex-grow">
                            <div className="flex justify-between">
                ...
                <div className="card w-full md:w-[80%] xl:w-[50%] bg-gray-800 rounded-lg shadow-lg p-6 text-white mx-auto">
                    ...
                    <div className="technology mb-4 flex items-center">
                        <img src="public\images/mongodb.png" alt="HTML" className="w-6 h-6 mr-2 bg-white rounded-sm" />
                        <div className="flex-grow">
                            <div className="flex justify-between">
                    ...
                    <div className="technology mb-4 flex items-center">
                        <img src="public\images/mongoose.png" alt="CSS" className="w-6 h-6 mr-2 bg-white rounded-sm" />
                        <div className="flex-grow">
                            <div className="flex justify-between">
                ...
                <div className="card w-full md:w-[80%] xl:w-[50%] bg-gray-800 rounded-lg shadow-lg p-6 text-white mx-auto">
                    ...
                    <div className="technology mb-4 flex items-center">
                        <img src="public\images/auth.jpg" alt="HTML" className="w-6 h-6 mr-2 bg-white rounded-sm" />
                        <div className="flex-grow">
                            <div className="flex justify-between">
                    ...
                    <div className="technology mb-4 flex items-center">
                        <img src="public\images/LS.jpg" alt="CSS" className="w-6 h-6 mr-2 bg-white rounded-sm" />
                        <div className="flex-grow">
                            <div className="flex justify-between">
